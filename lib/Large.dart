        ...
        children: [
          ...
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_14.png', 'img1');
                },
                child: Expanded(
                  child: Padding(
              ...
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_15.png', 'img2');
                },
                child: Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
          ...
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_16.png', 'img3');
                },
                child: Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
              ...
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_17.png', 'img4');
                },
                child: Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
          ...
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_18.png', 'img5');
                },
                child: Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
              ...
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_19.png', 'img6');
                },
                child: Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
