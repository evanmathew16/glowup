        ...
        children: [
          ...
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_26.png', 'img1');
                },
                child: Expanded(
                  child: Padding(
              ...
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_27.png', 'img2');
                },
                child: Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
          ...
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_28.png', 'img3');
                },
                child: Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
              ...
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_29.png', 'img4');
                },
                child: Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
          ...
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_30.png', 'img5');
                },
                child: Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
              ...
              GestureDetector(
                onTap: () {
                  _showFullScreenImage(context, 'assets/images/img_31.png', 'img6');
                },
                child: Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
